...
| GitHub host | GitHub.com only for the current `0.4.x` release line |
...
The current `0.4.x` release line supports **GitHub.com only**. GitHub Enterprise Server and other hosts are unsupported/deferred and fail closed through the public host guard.
