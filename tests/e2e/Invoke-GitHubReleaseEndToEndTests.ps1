...
try {
    ...
    Start-Sleep -Seconds 1
    Invoke-E2eNativeCommand -FilePath 'gh' -ArgumentList @('release', 'create', 'v1.1.0', '--repo', $sourceRepository, '--title', 'Release 1.1.0', '--notes', 'Stable release 1.1.0', "$asset110#stable-110") | Out-Null
